  ...
  return (
    <section id="connect" className="py-24 px-4 sm:px-6 lg:px-8 relative">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          <div className="portfolio-card rounded-3xl p-8 sm:p-12 md:p-16 bg-white/90 dark:bg-navy-900/80 border border-slate-200 dark:border-white/15 hover:border-slate-300 dark:hover:border-cyan/30 shadow-2xl relative overflow-hidden backdrop-blur-xl">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-4">
                {primaryLinks.map((link) => (
                  <a
                    ...
                    className="portfolio-card p-4 rounded-2xl bg-slate-50 dark:bg-navy-950/70 border border-slate-200 dark:border-white/5 hover:border-slate-300 dark:hover:border-cyan/30 group"
                  >
